...
min="1" max="510" required><br>DMX mode: <select name="DM"><option value="0">
Disabled</option><option value="1">Single RGB</option><option value="2">
Single DRGB</option><option value="3">Effect</option><option value="7">
Effect + White</option><option value="8">Effect Segment</option><option 
value="9">Effect Segment + White</option><option value="4">Multi RGB</option>
<option value="5">Dimmer + Multi RGB</option><option value="6">Multi RGBW
</option><option value="10">Preset</option></select><br><a 
