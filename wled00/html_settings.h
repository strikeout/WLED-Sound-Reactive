...
var d=document;function H(){window.open("https://github.com/atuline/WLED/wiki/Squelch-and-Gain")}function B(){window.open("/settings","_self")}function S(){GetV(),enDM()}function enDM(){var n=parseInt(d.getElementById("dme").value);d.getElementById("dm").style.display=n>=1?"inline":"none",d.getElementById("dm_mclk").style.display=2==n||4==n?"inline":"none",d.getElementById("am").style.display=0==n?"inline":"none"}function GetV() {var d=document;
%CSS%%SCSS%</head><body onload="S()"><form
 id="form_s" name="Sf" method="post"><div class="helpB"><button type="button" 
onclick="H()">?</button></div><button type="button" onclick="B()">Back</button>
...
min="-1" max="40" name="CK"><br><div id="dm_mclk">I2S MCLK pin: <input 
type="number" min="-1" max="3" name="MCLK"><br></div></div><i>
