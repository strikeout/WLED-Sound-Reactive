...
<input type="number" min="-1" max="40" name="DI"><span id="dm_pdmdat">&nbsp;<i>
DATA</i></span><br>I2S WS pin: <input type="number" min="-1" max="40" name="LR">
<span id="dm_pdmclk">&nbsp;<i>CLK</i></span><br><div id="dm_sck">I2S SCK pin: 
<input type="number" min="-1" max="40" name="CK"><br></div><div id="dm_mclk">
I2S MCLK pin: <input type="number" min="-1" max="3" name="MCLK"><br></div></div>
<i>Changing the microphone type or pins requires a hard reset/power cycle</i>
<br><div id="am">Analog Input pin: <input type="number" min="-1" max="40" 
name="SI"><br></div><p><a 
