...
#define VERSION 2211291                // WLEDSR specific version
#define SR_VERSION_NAME "0.13.3.4"     // WLEDSR version name --> some files need manual updating: package.json, package-lock.json, improv.cpp
