...
#define VERSION 2210160                // WLEDSR specific version
#define SR_VERSION_NAME "0.13.3-dev"   // WLEDSR version name --> some files need manual updating: package.json, package-lock.json, improv.cpp
